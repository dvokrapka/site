<div id="actionPanel" class="uk-navbar uk-navbar-attached uk-margin-bottom" data-type="category" data-uk-sticky>
	<ul class="uk-navbar-nav uk-text-uppercase">
		<li>
			<a href=""><i class="uk-icon-folder-o">&ensp;</i>Категорії</a>
		</li>
		<?php if ($parent['id']) : ?>
		<li>
			<a href="<?php echo $mod['index'] . 'categories/' . $parent['id']; ?>" class="uk-link-muted uk-text-uppercase uk-text-primary">
...
<div class="mech-box">
	...
	<div id="elList" class="uk-grid uk-grid-small uk-margin">
		<!-- Categories list -->
		<div class="uk-width-large-1-5 uk-hidden-small">
