<div class="uk-form-row" data-lib="<?php echo $lib_name; ?>" data-page="<?php echo ($page_id ?? null); ?>">
	...
	<div class="uk-form-controls" data-uk-margin>
		...
		&ensp;<i class="uk-icon-small uk-icon-hover uk-icon-edit" data-lib-edit data-uk-tooltip title="Редагувати список елементів"></i>
		<input type="hidden" name="options[widget][<?php echo $lib_name; ?>][items]" value='<?php echo $items; ?>'>
	</div>
</div>