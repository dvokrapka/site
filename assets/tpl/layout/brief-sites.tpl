<form class="brief-form">
    ...
    <div class="dv-form-row">
        ...
        <div class="dv-form-input">
            <textarea name="sphere" class="write-answer" rows="5"></textarea>
        </div>
    </div>
    <div class="dv-form-row">
        <div class="dv-form-title">
            ...
            <div class="dv-input-slider">
                <div class="srange-spans">
                    <input class="min-cost" type="number" min="0" step="1">
                  	<span></span>
                    <input class="max-cost" type="number" max="500" step="1">
                </div>
    ...
    <div class="dv-form-row">
        ...
        <div class="dv-form-input">
            <div class="dv-input-slider">
                <div class="srange-spans">
                    <input class="min-cost" type="number" min="0" step="50">
                  	<span></span>
    ...
    <div class="dv-form-row">
        ...
        <div class="dv-file-upload">
            <input name="brandbook" type="file" multiple>
            <svg class="upload-ico" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 21000 29700">
