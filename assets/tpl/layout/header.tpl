<header>
    <!-- Logo -->
    <svg class="toplogo" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 10154.84 2105.28" >
    ...
    <div id="goTop" class="scroll-top">
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" version="1.1" viewBox="0 0 5000 5000">
